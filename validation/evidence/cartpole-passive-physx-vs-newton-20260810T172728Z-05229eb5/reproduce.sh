#!/usr/bin/env bash
# Reproduce IVF run cartpole-passive-physx-vs-newton-20260810T172728Z-05229eb5
#
...
ivf --results-root ivf-results validate "${repository_root}/validation/examples/cartpole_cross_backend.yaml"

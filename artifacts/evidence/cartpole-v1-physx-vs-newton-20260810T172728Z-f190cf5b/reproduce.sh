#!/usr/bin/env bash
# Reproduce IVF run cartpole-v1-physx-vs-newton-20260810T172728Z-f190cf5b
#
...
ivf --results-root ivf-results validate "${repository_root}/validation/examples/cartpole_physx_vs_newton_v1.yaml"

...
IVF-CONTROL-FRAME-CONVENTION-MISMATCH       IVF-CONTROL-QUATERNION-CONVENTION-MISMATCH
IVF-CONTROL-RESET-SEMANTICS-MISMATCH        IVF-CONTROL-ENV-ORDER-MISMATCH
IVF-CONTROL-ACTION-TIMING-MISMATCH
```

### Capture boundary
```
IVF-BUNDLE-INCOMPLETE                       IVF-BUNDLE-CHECKSUM-MISMATCH
IVF-BUNDLE-CHECKSUM-MISSING                 IVF-BUNDLE-QUATERNION-AMBIGUOUS
IVF-BUNDLE-ARRAY-SHAPE-INCONSISTENT         IVF-BUNDLE-ARRAY-DTYPE-INCONSISTENT
IVF-BUNDLE-PARTIAL-UNDECLARED               IVF-BUNDLE-CONTRACT-INCOMPLETE
IVF-BUNDLE-CONTRACT-MISSING                 IVF-BUNDLE-SCHEMA-UNSUPPORTED
IVF-BUNDLE-FRAME-UNDECLARED                 IVF-BUNDLE-RESET-UNDECLARED
